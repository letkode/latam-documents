...
All notable changes to `letkode/latam-documents` will be documented in this file.
...
### Added
- Initial release of the `letkode/latam-documents` library.
...
[Unreleased]: https://github.com/letkode/latam-documents/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/letkode/latam-documents/releases/tag/v1.0.0
